...
│                                                                     │
│   1. git clone https://github.com/Vtheonly/Nasa_Hackathon_2025      │
...
3. Run the cells top-to-bottom. The notebook:
   - Clones this repo into `/content/Nasa_Hackathon_2025/`
...
The entire system follows the same engineering standards:
...
MIT — see [`electpynasa/pyproject.toml`](electpynasa/pyproject.toml) and [`galaxyviewer/package.json`](galaxyviewer/package.json).
